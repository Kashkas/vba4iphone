...
"movvs %4, #1\n\t" \
"movvc %4, #0\n\t" \
: "=r" (reg[dest].I), "=r" (N_FLAG), "=r" (Z_FLAG), "=r" (C_FLAG), "=r" (V_FLAG)\
: "r" (value), "r" (reg[base].I));


#define OP_RSB \
asm volatile("rsb %0, %2, %1"\
: "=r" (reg[dest].I)\
: "r" (value), "r" (reg[base].I));

#define OP_RSBS  \
asm volatile("rsbs %0, %6, %5\n\t"\
"movmi %1, #1\n\t" \
"movpl %1, #0\n\t" \
"moveq %2, #1\n\t" \
"movne %2, #0\n\t" \
...
#define OP_ADC \
asm  volatile("tst %3, #0\n\t"\
"adc %0, %1, %2"\
: "=r" (reg[dest].I)\
: "r" (value), "r" (reg[base].I), "r"(C_FLAG));
...
#define ARITHMETIC_LSL_REG \
asm volatile("mov %0,%1,lsl %2\n\t"\
: "=r" (value)\
: "r" (reg[opcode & 0x0f].I), "r" (shift));

#define ARITHMETIC_LSR_REG \
asm volatile("mov %0,%1,lsr %2\n\t"\
: "=r" (value)\
: "r" (reg[opcode & 0x0f].I), "r" (shift));

#define ARITHMETIC_ASR_REG \
asm volatile("mov %0,%1,asr %2\n\t"\
: "=r" (value)\
: "r" (reg[opcode & 0x0f].I), "r" (shift));

#define ARITHMETIC_ROR_REG \
asm volatile("mov %0,%1,ror %2\n\t"\
: "=r" (value)\
: "r" (reg[opcode & 0x0f].I), "r" (shift));      


#define ARITHMETIC_RRX_REG \
asm volatile("tst %2, #0\n\t"\
"mov %0,%1,rrx\n\t"\
: "=r" (value)\
: "r" (reg[opcode & 0x0f].I), "r"(C_FLAG));       
